...
@section('header')
<img src="images/commercial.jfif" class="card-img-top mb-3" style="width:100%; height:60%; opacity: 0.4;" alt="Commerical">
<div class="card-img-overlay d-flex flex-column justify-content-middle">
    <h1>Commercial Premises</h1>
</div>
@endsection
@section('summary')
