...
@section('header')
<img src="images/directors.jpeg" class="card-img-top mb-3" style="width:100%; height:60%; opacity: 0.4;" alt="Directors And Officers">
<div class="card-img-overlay d-flex flex-column justify-content-end">
    <h1>Directors And Officers</h1>
</div>
@endsection
           
@section('summary')
<p class="lead">Headline about the policy and what it offers</p>
<p> Some more text about the policy and things</p>
